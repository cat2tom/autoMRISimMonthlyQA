...
function autoMonthlyQAProcessorDirMO(image_dir_name,tmpTxtFileName,recordTxtFileName,mat_file,headCell)
...
if ~isempty(pNewFileList)
       ...
       % images. 
       if rem(length(pNewFileList),128)==0 % as 128 images for each QA, then to see if all 10 images arrived.
